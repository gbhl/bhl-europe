...
<xsl:stylesheet version="1.0"
	...
	xmlns:mods="http://www.loc.gov/mods/v3" xmlns:dwc="http://rs.tdwg.org/dwc/terms/">
	...
	<xsl:template match="mods:mods" name="mods">
		...
		<xsl:variable name="rform"
			select="mods:physicalDescription/mods:reformattingQuality" />
		<xsl:variable name="intm"
		...
		<xsl:variable name="dorigin"
			select="mods:physicalDescription/mods:digitalOrigin" />
		...
		<xsl:variable name="hierarchic"
			select="mods:subject/mods:hierarchicalGeographic" />
	...
	<xsl:template match="mods:name" name="mods-name">
		<xsl:element name="field">
			...
			<xsl:choose>
				<xsl:when
					test="mods:namePart[@type='family'] or mods:namePart[@type='given']">
	...
	<xsl:template match="mods:subject" name="mods-subject">
		...
		<xsl:variable name="topic"
			select="mods:topic|mods:occupation|mods:titleInfo" />
