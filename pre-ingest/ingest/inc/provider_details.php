...
echo " <sup>*enter new one to change</sup> ";
...
icon("history_21.gif"," ingest history ...[click for details]"); echo " Ingest History</a>"._TR;

// CONTENT HOME
echo "Content Home"._TD;        textfeld("user_content_home",$arrProvider['user_content_home'],55);
lz(3);
...
// KUERZEL
echo _TR."Provider Token"._TD;  textfeld("user_content_id",$arrProvider['user_content_id'],45);
echo " <sup>*defines your working directory</sup> ";

// CONFIGS
echo _TR."Ingest Config"._TD;   textfeld("user_config",$arrProvider['user_config'],55);
echo _TR."Schema Mapping"._TD;  textfeld("user_config_smt",$arrProvider['user_config_smt'],55);
